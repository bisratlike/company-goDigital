...
class employeeController {
  static async createEmployee(req, res) {
    ...
    try {
      ...
      const mailOptions = {
        ...
        text: `Dear ${req.body.fullName},\n\nWelcome to our company! Your account has been successfully created.your role is ${req.body.role} Your password is: ${req.body.password}`,
      };
      ...
      console.error(
        `Error occurred while creating an employee: ${error.message}`
      );
      return res
        .status(500)
        .json({ error: "An error occurred while creating an employee." });
    }
  }
  ...
  static async getAllEmployees(req, res) {
    try {
      ...
      console.error(
        `Error occurred while retrieving employees: ${error.message}`
      );
      return res
        .status(500)
  ...
  static async updateEmployee(req, res) {
    ...
    try {
      ...
      existingEmployee.fullName =
        req.body.fullName || existingEmployee.fullName;
      ...
      console.error(
        `Error occurred while updating an employee: ${error.message}`
      );
      return res
        .status(500)
        .json({ error: "An error occurred while updating an employee." });
    }
  }
}
